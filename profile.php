    ...
    <head>
        ...
        /*MOBILE CLASSES*/
            ...
            .mobile .popBar {
                ...
                .mobile .popBar button {
                    border-radius: 10px;
                }
            .mobile .profile_backPhoto {
                margin-top: 10px;
            }
            .mobile .mobileNav {
                display: block;
                ...
                .mobile .mobileNav .carousel-cell {
                  width: 100%;
                  height: 50px;
                  line-height: 50px;
                  margin-right: 10px;
                ...
                .mobile .mobileNav .flickity-page-dots { 
                       display: none;
                }
                .mobile .mobileNav .flickity-button {
                  background: transparent;
                }
                .mobile .mobileNav .flickity-prev-next-button {
                  width: 50px;
                  height: 50px;
                }
                .mobile .mobileNav .flickity-button-icon {
                  fill: white;
                }
                .mobile .mobileNav .flickity-button:disabled {
                  display: none;
                }
            .mobile .cardNavBodyContainer {
                display: grid;
            ...
            .mobile .gridTable {
                ...
                .mobile #IDFinance .profileCard header{
                    display: grid;
                    grid-gap: 5px;
                    justify-content: center;
                    text-align: center;
            ...
            .mobile .left-nav {
                ...
                .mobile .popMenuGrid {
                    display: grid;
                    grid-template-rows: 61px 1fr 52px;
                }
                .mobile .popHeader {
                    grid-row: 1;
                ...
                .mobile .popMenuBody {
                    ...
                    .mobile .popMenuItem {
                        ...
                        .mobile .popMenuItem:hover {
                            background:white;
                            color: #343a40;
                        }
                        .mobile .popMenuItem i {
                            grid-row: 1;
                            grid-column: 1;
                        }
                        .mobile .popMenuItem h2 {
                            grid-row: 2;
                            grid-column: 1;
                            font-size: 25px;
                            font-weight: bold;
                    ...
                    .mobile .popSubMenuItem {
                        border-bottom: 1px #343a40 solid;
                        padding:5px 10px;
                        margin:5px;
                    }
                    .mobile .popSubMenuItem:hover {
                        background-color:cadetblue;
                        border-radius: 10px;
                        color:white
                    }
